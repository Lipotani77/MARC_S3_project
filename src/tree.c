...
t_tree create_tree(t_localisation loc, t_map map, hand hand_of_moves){
    t_tree new_tree;

    new_tree.root = create_node(map.costs[loc.pos.x][loc.pos.y],loc.pos.x,loc.pos.y,loc.ori, NULL);
